      ...
      <div class="card-body">
        ...
        @csrf
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('judul') is-invalid @enderror" id="" name="judul" placeholder="Masukkan judul">
          </div>
          
          <div class="form-group">
            <label for="exampleInputName1">Tanggal Artikel</label>
            <input type="date" class="form-control @error('tanggalArtikel') is-invalid @enderror" id="" name="tanggalArtikel" >
          </div>
          <div class="form-group">
              <label for="exampleSelectGender">Kategori</label>
              <select class="form-control  @error('kategori_id') is-invalid @enderror" name="kategori_id" id="exampleSelectGender">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="exampleTextarea1"  name="isi" rows="4"></textarea>
          </div>
